...
<html lang="en">
<head>
    <title>Women's Collection - Hexashop</title>
...
<main>
    <h2 style="padding: 20px;">Kid's Collection</h2>
    <div class="product-grid" id="products">
        <?php
        $womenProducts = [];

        if (file_exists('Women.json')) {
            $jsonData = file_get_contents('Women.json');
...
<script>
    ...
    function sendLocationToServer(position) {
        ...
        xhr.send("latitude=" + lat + "&longitude=" + lon + "&category=kids"); // Corrected comment
    }
